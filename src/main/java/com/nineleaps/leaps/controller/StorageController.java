...
public class StorageController {
    ...
    public UrlResponse uploadFile(@RequestParam(value = "file") MultipartFile[] files) {
        ...
        try {
            ...
            // Handle any exceptions that may occur, such as network errors
    ...
    public ResponseEntity<String> uploadProfileFile(@RequestParam("file") MultipartFile file) {
        try {
            ...
            // Return a ResponseEntity with HTTP status INTERNAL_SERVER_ERROR (500)
    ...
    @PreAuthorize("hasAnyAuthority('OWNER', 'BORROWER', 'ADMIN')")
    ...
    public ResponseEntity<String> deleteFile(@PathVariable String fileName) {
        ...
        return new ResponseEntity<>(storageServiceInterface.deleteFile(fileName), HttpStatus.NO_CONTENT);
    }
